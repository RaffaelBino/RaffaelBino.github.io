...
!function (i) { i.fn.skillbar1 = function (t) { var e = i.extend({ speed: 1e3, bg: "" }, t), n = e.bg, d = i(this).find(".filled1"), s = i(this).find(".title1"); return n ? (d.css({ "background-color": n }), s.css({ "background-color": "rgba(0,0,0,0.5)" })) : this.each(function (t) { i(this).find(".filled1").animate({ width: i(this).find(".filled1").data("width") }, e.speed) }), this } }(jQuery);
